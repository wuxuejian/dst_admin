...
<div style="padding:15px"> 
    <form action="<?php echo yii::$app->urlManager->createUrl(['drbac/user/mac-import']); ?>" id="easyui-form-drbac-user-import" class="easyui-form" method="post" enctype="multipart/form-data">
...
//提交表单
	DrbacUserIndex.import2 = function(){
		console.log("hi");
	    var form = $('#easyui-form-drbac-user-import');
