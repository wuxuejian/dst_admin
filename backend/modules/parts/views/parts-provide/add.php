<form id="search-form-parts-provide-add" method="post">
        <table cellpadding="8" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <select class="easyui-combobox" id="s_city" name="home_shi" style="width:60px;"></select>
                    <select class="easyui-combobox" id="s_county" name="home_qu" style="width: 70px;"></select>
                </td>
...
<script>
    //构建查询表单
    var searchForm = $('#search-form-parts-provide-add');
    //汽车品牌下拉
