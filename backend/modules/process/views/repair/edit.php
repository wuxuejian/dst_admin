<div style="padding:10px 40px 20px 40px">  
    <form id="easyui-form-process-repair-edit" class="easyui-form" method="post">
    <input type="hidden" name="id" />
        <div >
            <ul class="ulforform-resizeable">
                ...
                <li class="ulforform-resizeable-group">
                    <div class="ulforform-resizeable-title">来电号码</div>
                    <div class="ulforform-resizeable-input">
                ...
                <li class="ulforform-resizeable-group-single">
                    ...
                    <div class="ulforform-resizeable-input">
                        <input class="easyui-textbox" style="width:160px;"   name="address"  missingMessage="请输入故障地点"/>
                    </div>
                </li>
                <li class="ulforform-resizeable-group-single">
                    <div class="ulforform-resizeable-title">所处方位</div>
                    <div class="ulforform-resizeable-input">
                        <input class="easyui-textbox" style="width:160px;"   name="bearing"  missingMessage="请输入车辆在该地点的具体位置"/>
                    </div>
                </li>
                <li class="ulforform-resizeable-group-single">
...
<script>
$('#easyui-form-process-repair-edit').form('load',<?= json_encode($result); ?>);
</script>