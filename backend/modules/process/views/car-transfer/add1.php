...
<table id="easyui-datagrid-process-car-transfer1-add"></table>
<!-- toolbar start -->
<div id="process-car-transfer1-add-toolbar">
    <form id="easyui-form-process-car-transfer1-index-add" class="easyui-form" method="post" enctype="multipart/form-data">
...
<!-- 窗口 -->
<script>
    var ProcessCarTransfer1Add = new Object();
    //提交表单
    ProcessCarTransfer1Add.submitForm = function(){
        var form = $('#easyui-form-process-car-transfer1-index-add');
        if(!form.form('validate')){
            return false;
        }
		form.ajaxSubmit({
			url: "<?php echo yii::$app->urlManager->createUrl(['process/car-transfer/add1']); ?>",
			dataType : "json",
