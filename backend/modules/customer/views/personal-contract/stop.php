<div style="padding:10px;">
    <form id="easyui-form-customer-personal-contract-index-stop">
        ...
        <ul class="ulforform-resizeable">
            <li class="ulforform-resizeable-group">
                   ...
                   <div class="ulforform-resizeable-input">
                    <input class="easyui-combotree" name="stop_type" style="width:180px;" id="easyui-form-customer-personal-contract-index-stop-type" 
                           data-options="
            ...
            <li class="ulforform-resizeable-group">
                ...
                <div class="ulforform-resizeable-input">
                    <select
                        id="easyui-form-customer-personal-contract-index-stop-cause"
...
<script>
	...
	function stopTypeLoadSuccess(){
		$("#easyui-form-customer-personal-contract-index-stop-type").combotree('setValue',stop_type);
		initStopCause(stop_type);
	}
	function initStopCause(stop_type){
		$('#easyui-form-customer-personal-contract-index-stop-cause').combotree({
			...
			onLoadSuccess: function(data){ //展开到当前菜单位置
				$("#easyui-form-customer-personal-contract-index-stop-cause").combotree('setValue',stop_cause);
			}
		});
	}
	function loadStopCause(rec){
		...
		$('#easyui-form-customer-personal-contract-index-stop-cause').combotree({
			...
			lines:false,
			onLoadSuccess: function(data){ //展开到当前菜单位置
				$("#easyui-form-customer-personal-contract-index-stop-cause").combotree('setValue',0);
			}
		});
	}
	//表单赋值
