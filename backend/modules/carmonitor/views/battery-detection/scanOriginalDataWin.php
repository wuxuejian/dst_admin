<div id="echart-carmonitor-battery-detect-detail-dashboard" style="width:1100px;height:340px;margin:0 auto;"></div>
<div style="border:1px dashed #ddd;border-radius:4px;margin:10px;">
    ...
    <form id="easyui-from-carmonitor-battery-detect-detail-baseinfo" style="overflow:hidden;">
        <?php
...
<div id="echart-carmonitor-battery-detect-detail-battery-t" style="width:1150px;height:300px;margin:0 auto;"></div>
<div id="echart-carmonitor-battery-detect-detail-battery-v" style="width:1150px;height:300px;margin:0 auto;"></div>
<!-- 电机数据开始 -->
<div style="border:1px dashed #ddd;border-radius:4px;margin:10px;">
    <div style="padding:10px;font-size:18px;color:#333;font-weight:bold;">驱动电机数据</div>
    <form id="easyui-from-carmonitor-battery-detect-detail-moter" style="overflow:hidden;">
        <?php
            $useColumns = [
...
<div style="border:1px dashed #ddd;border-radius:4px;margin:10px;">
    ...
    <form id="easyui-from-carmonitor-battery-detect-detail-extremum" style="overflow:hidden;">
        <?php
            $useColumns = [
...
<div style="border:1px dashed #ddd;border-radius:4px;margin:10px;">
    ...
    <form id="easyui-from-carmonitor-battery-detect-detail-otherdata" style="overflow:hidden;">
        <?php
            $useColumns = [
...
<script>
    ...
    CarmonitorDetectDetail.drawDashboard = function(d){
        ...
        if(this.chartObject.dashboardChart){
            ...
            var dashboardChart = echarts.init(document.getElementById('echart-carmonitor-battery-detect-detail-dashboard'));
    ...
    CarmonitorDetectDetail.drawBatteryTemperature = function(d){
        ...
        if(this.chartObject.batteryTemChart){
            ...
            var chat = echarts.init(document.getElementById('echart-carmonitor-battery-detect-detail-battery-t'));
    ...
    CarmonitorDetectDetail.drawBatteryVoltage = function(d){
        ...
        if(this.chartObject.batteryVolChart){
            ...
            var chat = echarts.init(document.getElementById('echart-carmonitor-battery-detect-detail-battery-v'));
    ...
    */
    ...
    CarmonitorDetectDetail.loadData = function(d){
        ...
        $('#easyui-from-carmonitor-battery-detect-detail-baseinfo').form('load',data);
        $('#easyui-from-carmonitor-battery-detect-detail-moter').form('load',data);
        $('#easyui-from-carmonitor-battery-detect-detail-extremum').form('load',data);
        $('#easyui-from-carmonitor-battery-detect-detail-otherdata').form('load',data);
    }
