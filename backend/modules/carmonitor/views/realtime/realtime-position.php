...
<script type="text/javascript">
    ...
    function requestData(){
        $.ajax({
            'type':'post',
            'url':"<?php echo yii::$app->urlManager->createUrl(['carmonitor/realtime/realtime-position']); ?>",
            'data': {'car_vin': "<?= $carVin; ?>"},
            'dataType':'json',
            'success': function(rData){
                if(rData.status){
                    ...
                    transPosition({
                        "longitude_value": transPointInfo.longitude_value,
                        "latitude_value": transPointInfo.latitude_value
                    });
                }else{
