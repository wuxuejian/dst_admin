<form id="easyui-form-system-code-update-log-add" method="post" style="padding:5px;">
        <ul class="ulforform-resizeable">
            ...
            <li class="ulforform-resizeable-group">
                ...
                <div class="ulforform-resizeable-input">
                    <select class="easyui-combobox" name="product" style="width:153px;" required="true">  
                        <option value=""></option>
                        <option value="1">地上铁APP</option>
                        <option value="2">地上铁系统</option>
                    </select>
                </div>
            </li>
            <li class="ulforform-resizeable-group">
            ...
            <li class="ulforform-resizeable-group">
                ...
                <div class="ulforform-resizeable-input">
                    <input class="easyui-textbox" name="module"></input>
                </div>
            </li>
            <li class="ulforform-resizeable-group">
                <div class="ulforform-resizeable-title">版本号</div>
                <div class="ulforform-resizeable-input">
                    <input class="easyui-textbox" name="version_number"></input>
                </div>
            </li>
            <li class="ulforform-resizeable-group">
                <div class="ulforform-resizeable-title">升级日期</div>
                <div class="ulforform-resizeable-input">
                    <input class="easyui-datebox" type="text" name="update_date" style="width:93px;" required="true"/>
                </div>
            </li>
