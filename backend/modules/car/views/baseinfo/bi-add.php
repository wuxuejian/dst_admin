<div style="padding:15px"> 
    <form id="easyui-form-car-baseinfo-bi-add">
        <input type="hidden" name="car_id" value="<?php echo $carId; ?>" />
        <table cellpadding="8" cellspacing="0">
            <tr>
                <td><div style="width:85px;text-align:right;">保险公司</div></td>
                <td>
                    <input name="insurer_company" style="width:160px;" />
                </td>
...
<script type="text/javascript">
    var CarBaseinfoBiAdd = {
        init: function(){
            $('#easyui-form-car-baseinfo-bi-add').find('input[name=insurer_company]').combobox({
                required: true,
                panelHeight: 'auto',
                valueField: 'value',
                textField: 'text',
