<!-- <div class="easyui-tabs" data-options="fit:true,border:false">  -->
    <!-- 车辆基本信息 -->
    <!-- <div title="车辆模板修改" style="padding:15px"> -->
        <form id="easyui-form-car-type-edit" method="post" class="easyui-form">
                ...
                <td>
                    <input
                        ...
                        data-options="{onChange: function(){
                            CarBaseinfoEdit.getCarModelName($(this).val());
                        }}"
    ...
    >
       <table cellpadding="5" cellspacing="0">
            ...
            <tr>
                <td align="right"><div style="width:70px;">动力电池容量(kW·h)</div></td>
                <td>
                    <input
                        class="easyui-textbox"
                        style="width:160px;"
...
<script>
    ...
    $('#easyui-form-car-type-edit').form('load',faultInfo);

    //获取填写车型的车辆名称
    var CarBaseinfoEdit = {
        params: {
            oldData: <?php echo json_encode($row); ?>,
        },
        init: function(){
