		...
		<table cellpadding="8" cellspacing="2" style="width:100%;" border="0">
            ...
            <div class="easyui-panel" title="1.车辆保险信息" style="padding:8px 0px;"
...
<div class="easyui-panel" title="2.车辆出险信息" style="padding:8px 0px;"
                 data-options="collapsible:true,collapsed:false,border:false,fit:false">
	<table cellpadding="8" cellspacing="2" style="width:100%;" border="0">
                    <tr>
                    ...
                    <tr>
                    	<th align="right" width="10%">查勘类型：</th>
                        <td colspan="7">
                        	<?php 
