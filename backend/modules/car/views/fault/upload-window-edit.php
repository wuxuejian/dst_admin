<form
    id="easyui-form-car-fault-edit-upload-window"
    target="iframe-car-fault-edit-uploadimage"
    action="<?= yii::$app->urlManager->createUrl(['car/fault/upload-thumb']); ?>&isEdit=1"
    method="post"
