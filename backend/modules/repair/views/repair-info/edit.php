<form id="easyui-form-repair-info-edit" class="easyui-form">
    <div
        class="easyui-panel"
        title="基本信息"
        ...
        <table cellpadding="5" cellspacing="0">
            ...
            <tr>
               ...
               <td align="right"><div style="width:70px;">进厂时间</div></td>
                <td>
                    <input class="easyui-datetimebox" style="width:160px;"  name="in_time"  id="in_time"  required value="<?php echo $data['into_time'];?>"  />
                </td>
                <td align="right"><div style="width:70px;">预计出厂时间</div></td>
                <td>
                   <input class="easyui-datetimebox" type="text" name="expect_time" style="width:160px;" required="true" value="<?php echo $data['expect_time'];?>" />
                </td>
            </tr>
            <tr>
