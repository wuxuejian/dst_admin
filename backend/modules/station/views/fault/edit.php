<div style="padding:10px 40px 20px 40px">  
    <form id="easyui-form-station-fault-edit" class="easyui-form" method="post">
        ...
        <div >
            <ul class="ulforform-resizeable">
                ...
                <li class="ulforform-resizeable-group-single">
                    ...
                    <div class="ulforform-resizeable-input">
                        <input class="easyui-textbox" style="width:470px;"  name="category" required="true" value="<?php echo $result['category']?>" />
                    </div>
                </li>
                <li class="ulforform-resizeable-group">
                    <div class="ulforform-resizeable-title">编码</div>
                    <div class="ulforform-resizeable-input">
                        <input class="easyui-textbox" style="width:160px;"  name="code" required="true" value="<?php echo $result['code']?>" />
                    </div>
                </li>
                <li class="ulforform-resizeable-group">
                    <div class="ulforform-resizeable-title">东风原始故障码</div>
                    <div class="ulforform-resizeable-input">
                        <input class="easyui-textbox" style="width:160px;"  name="dfm_code"  value="<?php echo $result['dfm_code']?>" />
                    </div>
                </li>
            </ul>
        </div>
...
<script>
    var StationFalutCategory_addWin  = {
        init: function(){
            var curMenuId = <?php echo $result['pid']?>;
