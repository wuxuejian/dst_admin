<form id="chargeChargeCardIndex_rechargeWin_form" method="post" style="padding:5px;">
...
<script>
    // 加载出旧数据
    $('#chargeChargeCardIndex_rechargeWin_form').form('load',<?php echo json_encode($ChargeCardInfo); ?>);
