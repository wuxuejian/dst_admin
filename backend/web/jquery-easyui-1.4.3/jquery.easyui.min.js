...
_a37(this,q);
}},currentText:"Today",cleanText:"清除",closeText:"Close",okText:"Ok",buttons:[{text:function(_a4c){
...
return $(_a4e).datebox("options").cleanText;
},handler:function(_a4f){
$(_a4f).combo("setValue",'').combo("setText",'');
