<div style="padding:5px;">
    <form id="carmonitorBatteryDetectionIndex_setParamsWin_editCriteriaWin_form">
...
<script>
    ...
    $('#carmonitorBatteryDetectionIndex_setParamsWin_editCriteriaWin').form('load',oldData);
</script>