<form id="easyui_form_polemonitor_alert_shotmessage_rule" style="padding:10px;">
...
<script type="text/javascript">
    var PolemonitorAlertShotmessageRule = {
        params: {
            oldData: <?php echo json_encode($data); ?>
        },
        init: function(){
            $('#easyui_form_polemonitor_alert_shotmessage_rule').form('load',this.params.oldData);
        }
    };
    PolemonitorAlertShotmessageRule.init();
</script>