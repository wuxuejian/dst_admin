         ...
         data-options="collapsible:true,collapsed:false,border:false,fit:false">
            <ul class="ulforform-resizeable">
                ...
                <li class="ulforform-resizeable-group" >
                    ...
                    <div class="ulforform-resizeable-input">
                      <input id="easyui-form-car-fault-register-carCombogrid" class="easyui-textbox" style="width:160px;"  name="car_id"  value="<?php echo $row['car_id']?>"      />
                    </div>
                </li>                 
                <li class="ulforform-resizeable-group">
         ...
         data-options="collapsible:true,collapsed:false,border:false,fit:false">
         	<ul class="ulforform-resizeable">
                ...
                <li class="ulforform-resizeable-group-single">
                    ...
                    <div class="ulforform-resizeable-input">
                        <input type="checkbox" name="road_situation[]" value="有较深积水" <?php if(@in_array('有较深积水', $row['road_situation'])):  echo 'checked';next($row['road_situation']); endif;?>  />有较深积水（＞80mm）
                    </div>
                    <div class="ulforform-resizeable-input">
                        <input type="checkbox" name="road_situation[]" value="较为颠簸" <?php if(@in_array('较为颠簸', $row['road_situation'])):  echo 'checked';next($row['road_situation']); endif;?>  />较为颠簸
                    </div>
                    <div class="ulforform-resizeable-input">
                        <input type="checkbox" name="road_situation[]" value="交通拥堵" <?php if(@in_array('交通拥堵', $row['road_situation'])):  echo 'checked';next($row['road_situation']); endif;?>  />交通拥堵
                    </div>
                    <div class="ulforform-resizeable-input">
                        <input type="checkbox" name="road_situation[]" value="有坡度" <?php if(@in_array('有坡度', $row['road_situation'])):  echo 'checked';next($row['road_situation']); endif;?>  />有坡度
                    </div>
                    <div class="ulforform-resizeable-input">
                        <input type="checkbox" name="road_situation[]" value="路况正常" <?php if(@in_array('路况正常', $row['road_situation'])):  echo 'checked'; endif;?>   />路况正常
                    </div>
                </li>
                <li class="ulforform-resizeable-group-single">
                 ...
                 <li class="ulforform-resizeable-group-single" style="height:60px;">
					...
					<div class="ulforform-resizeable-input">
						...
						<input type="hidden" name="indicator_light"  value="<?php echo $row['indicator_light'];?>" />
						<span  id="indicator_light">
							<?php if($row['indicator_light_image']):?>
							<?php foreach ($row['indicator_light_image'] as $val): ?>
								<img  class="repairImg" src="<?php echo $val['image_url']?>" width="40" height="40" title="<?php echo $val['name']?>"  />
							<?php endforeach;?>
							<?php endif;?>
						</span> 
					</div>
...
$(function(){
 ...
 $('#order_no').combobox({ 
	...
	//注意：加载成功后，若原本应显示为text的车牌号不存在，则改成显示车架号为text！
     var _combogrid = $('#easyui-form-car-fault-register-carCombogrid');
