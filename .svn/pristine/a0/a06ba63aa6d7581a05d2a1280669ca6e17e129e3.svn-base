<form id="easyui-form-customer-personal-edit" class="easyui-form">
...
<script>
    $('#easyui-form-customer-personal-edit').form('load',<?php echo json_encode($customerInfo); ?>);
	
	function search_baiDu_map() {
		$('#baiDuMapWin').dialog('open');
		var _url = '<?php echo yii::$app->urlManager->createUrl(['interfaces/interfaces/search-baidu-map']); ?>' + '&pageIn=personal_edit'; 
