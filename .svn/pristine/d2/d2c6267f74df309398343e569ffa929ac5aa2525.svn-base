    ...
    <form id="easyui-form-car-fault-register">
        <ul class="ulforform-resizeable">
            ...
            <li class="ulforform-resizeable-group-single">
                ...
                <div class="ulforform-resizeable-input">
                    <ul style="padding:0;margin:0;list-style:none;overflow:hidden;" id="car-fault-register-uploadfile">
                        <?php
                            $thumbs = [
                        ...
                        ?>
                            <li style="float:left;margin-right:16px;position:relative;cursor:pointer">
                                <div style="width:100px;height:100px;">
                                    <img class="faultImg" src="./images/add.jpg" width="100" height="100" />
...
<iframe id="iframe-car-fault-register-uploadimage" name="iframe-car-fault-register-uploadimage" style="display:none;"></iframe>
<div id="easyui-dialog-car-fault-register-uploadimage"></div>
<script type="text/javascript">
    var CarFaultRegister = {
        init: function(){
            //初始化照片上传窗口
            $('#easyui-dialog-car-fault-register-uploadimage').dialog({
                title: '车辆故障照片上传',   
                width: 500,   
                height: 160,   
                closed: false,   
                ...
                buttons: [{
                    ...
                    iconCls:'icon-ok',
                    handler:function(){
                        var form = $('#easyui-form-car-fault-register-upload-window');
                    ...
                    iconCls:'icon-cancel',
                    handler:function(){
                        $('#easyui-dialog-car-fault-register-uploadimage').dialog('close');
                    }
                }],
                onClose: function(){
                    $(this).window('clear');
            ...
            //给上传故障图片绑定各类事件
            $('#car-fault-register-uploadfile').children('li')
                .click(function(){ //单击打开上传窗口
                    var columnName = $(this).find('input').attr('name');
                    $('#easyui-dialog-car-fault-register-uploadimage')
                        .dialog('open')
                        .dialog('refresh',"<?= yii::$app->urlManager->createUrl(['car/fault/upload-window']); ?>&columnName="+columnName);
                })
                .mouseover(function(){
        ...
        uploadComplete: function(rData){
            ...
            if(rData.status){
                $('#easyui-dialog-car-fault-register-uploadimage').dialog('close');
                var inputControl = $('#car-fault-register-uploadfile').find('input[name='+rData.columnName+']');
