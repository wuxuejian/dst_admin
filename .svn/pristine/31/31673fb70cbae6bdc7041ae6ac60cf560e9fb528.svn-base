<form id="promotionLetInfoIndex_addWin_form" method="post" style="padding:10px 0px;">
    <table cellpadding="5" cellspacing="0" style="width:100%;" border="0">
        ...
        <tr>
            ...
            <td width="25%">
                <input name="renter_id" id="promotionLetInfoIndex_addWin_chooseRenter" style="width:160px;"  />
            </td>
            <td align="right" width="15%">手机号</td>
            <td>
                <input class="easyui-numberbox" name="renter_mobile" id="promotionLetInfoIndex_addWin_renterMobile" style="width:160px;" disabled="true" />
            </td>
        </tr>
        <tr>
...
<script>
    var promotionLetInfoIndex_addWin = {
        init:function(){
            // 初始化【选择租车客户】combogrid
            $('#promotionLetInfoIndex_addWin_chooseRenter').combogrid({
                panelWidth: 500,
                panelHeight: 200,
                scrollbarSize:0,
                pagination: true,
                ...
                onHidePanel:function(){
                    ...
                    if(text && rows.length < 1 && value == text){
                        ...
                        $('#promotionLetInfoIndex_addWin_form').form('load',data);
                    }
                }
            });
        }
    ...
    //执行初始化函数
    promotionLetInfoIndex_addWin.init();
