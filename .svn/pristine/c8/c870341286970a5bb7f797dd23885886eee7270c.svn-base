...
<div style="padding:10px 40px 20px 40px">
    <form action="<?php echo yii::$app->urlManager->createUrl(['process/contract-approval/edit']); ?>" id="easyui-form-process-contract-approval-edit" class="easyui-form" method="post" enctype="multipart/form-data">
    	...
    	<table cellpadding="5" cellspacing="0" width="100%" border="0">
    		...
    		<tr>
    			...
    			<td colspan="3">
    			    ...
    			    <input name="contract_url" type="text" disabled="disabled">
    			</td>
    		</tr>
    	</table>
    </form>
...
<script>
    var ProcessContractApprovalEdit = new Object();
  //提交表单
    ProcessContractApprovalEdit.submitForm = function(){
        var form = $('#easyui-form-process-contract-approval-edit');
  ...
  //表单赋值
    var oldData = <?php echo json_encode($obj); ?>;
    setTimeout(function(){
    	$('#easyui-form-process-contract-approval-edit').form('load',oldData);
    	if(oldData.business_way != '现金' && oldData.business_way != '支票' && oldData.business_way != '汇款'){

    		$("input[name=business_way][value='other']").attr("checked",true);
    		$('#other_business_way').textbox('setValue',oldData.business_way);
    	}
    },1000);
</script>