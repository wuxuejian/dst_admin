...
/**
 * This is the model class for table "{{%charge_spots_alert_shotmessage_rule}}".
 *
 * @property string $id
 ...
 */
class ChargeSpotsAlertShotmessageRule extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%charge_spots_alert_shotmessage_rule}}';
    }
