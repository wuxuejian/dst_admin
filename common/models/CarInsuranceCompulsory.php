...
/**
 * This is the model class for table "{{%car_insurance_compulsory}}".
 *
 * @property string $id
 ...
 */
class CarInsuranceCompulsory extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%car_insurance_compulsory}}';
    }
